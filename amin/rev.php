...
<body>
    ...
    <div class="humberger-menu-wrapper">
        ...
        <div class="hw-menu mobile-menu">
            <ul>
                ...
                <li><a href="categories.php">Categories <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown">
                ...
                <li><a href="reviews.php">Reviews <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown">
            ...
            <div class="container">
                ...
                <div class="nav-menu">
                    <ul>
                        ...
                        <li><a href="contact.php"><span>Contact <i class="fa fa-angle-down"></i></span></a></li>
    ...
    <section id="reviews" class="details-hero-section set-bg" data-setbg="img/details/details-post-review.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="dt-tags">
                        ...
                        <div class="dt-desc-more">
                            <p>Duis aute irure dolor inenim ad minim veniam, quis nostrud exercitation ullamco laboris
                                nisi ut aliquip ex ea commodo conslaboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                        <div class="dt-quote">
